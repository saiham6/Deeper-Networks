...
train_dataset = torchvision.datasets.CIFAR10(root=f'{data_path}/cifar', train=True, download=True, transform=trans_train)
test_dataset = torchvision.datasets.CIFAR10(root=f'{data_path}/cifar', train=False, download=True, transform=trans)
